...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_GAMEOBJECT_LIST actions', async () => {
    ...
    it('dispatches SEARCH_GAMEOBJECTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_GAMEOBJECT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_GAMEOBJECT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_GAMEOBJECT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_GAMEOBJECT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_GAMEOBJECT actions', async () => {
      const expectedActions = [
        {
